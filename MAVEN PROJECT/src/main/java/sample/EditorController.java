...
public class EditorController implements Initializable {
    ...
    public void submit() throws SQLException {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("success.fxml"));
    ...
    public void videopreview(){
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("videoplayer.fxml"));
    ...
    public void imagepreview() throws IOException {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("imagepreview.fxml"));
